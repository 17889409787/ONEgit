...
<%@include file="frame/head_A.jsp"%>
	...
	<form class="form-horizontal form-label-left" method="post" action="insert_A" onsubmit="return checkall()">
    <div class="top">
    <div class="top_content">
      <div class="header">新增商品信息</div>
    </div>
    </div>
    <div class="form">
   						 <div>
                        ...
                        <div>
                          <input id="proid" name="proid"  value=""  type="text" onblur="checkid()"><span id="demo4" style="color: red;"></span>
                        </div>
                      <div>
                        <label>名称<span >*</span>
                        </label>
                        ...
                        <div>
                          <input id="pname" name="pname" value=""  type="text" onblur="check()"><span id="demo1" style="color: red;"></span>
                        </div>                   
                      <div>
                        <label>售价 <span >*</span>
                        </label>
                        <div>
                          <input id="price" name="price" value=""  type="text" onblur="ischeckNum()"><span id="demo2" style="color: red;"></span>
                        </div>
                      </div>
                      <div>
                        <label >进价 <span >*</span>
                        ...
                        <div >
                          <input id="inprice"  name="inprice" value=""  type="text" onblur="ischeckinprice()">  <span id="demo3" style="color: red;"></span>                      
                      </div>
                      	</div>
                     <div>
                        ...
                        <div >
                          <input id="prodate"  name="prodate" value="" type="date"/>                 
                          </div>
                      </div>
                      <div >
                        ...
                        <div>
                          <input id="reledate" name="reledate"  value="" type="date"/>
                        </div>
                      </div> 
                       <div>
                        ...
                        <div>
                          <input id="supname" name="supname" value=""  type="text" required="">
                        </div>
                      </div>                      
                      <div>
                        ...
                        <div>
                          <input id="protype"  name="protype"value="" type="text" required="">
                        </div>
                      </div>                      
                        <div>
