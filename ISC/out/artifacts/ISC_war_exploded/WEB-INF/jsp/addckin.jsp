...
<%@include file="frame/head_A.jsp"%>
	...
	<form method="post" action="insert" onsubmit="return checkall()">
    <div class="top">
    <div class="top_content">
      <div class="header">新增进货信息</div>
    </div>
    </div>
    <div class="form">
                      <div>
                        <label>订单id<span >*</span>
                        </label>
                        <div >
                          <input id="inid" name="inid" value="" onblur="checkinid()" type="text" ><span id="demo1" style="color: red;"></span>
                        </div>
                      </div>
                      <div >
                        ...
                        <div >
                          <input id="proid" name="proid" value="${ckin.proid}"  type="text" onblur="checkproid()"><span id="demo3" style="color: red;"></span>
                        </div>
                      </div>
                      <div>
                        <label  >名称<span >*</span>
                        ...
                        <div >
                          <input id="pname" name="pname" value="${ckin.pname}" onblur="checkname()" type="text" ><span id="demo2" style="color: red;"></span>
                        </div>
                      </div>
                      <div >
                        <label >数量 <span >*</span>
                        ...
                        <div >
                          <input id="num" name="num" value=""  type="text" onblur="checknum()"><span id="demo4" style="color: red;"></span>
                        </div>
                      </div>
                     <div >
                        <label >进货日期<span >*</span>
                        </label>
                        <div >
                          <input id="indate"  name="indate" value="" type="date" >                        
                          </div>
                      </div>
                        <div >
                        <label >备注<span ></span>
...
function checkinid()
{
	...
	if( num )
		...
		return true;
		}else{cument.getElementById("demo1").innerHTML="请输入正确的订单id！";
